...
function DashboardPage() {
    ...
    const [, setAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])('tailor-track-session', false);
    ...
    const filteredCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[filteredCustomers]": ()=>{
            ...
            return customers.filter({
                "DashboardPage.useMemo[filteredCustomers]": (customer)=>customer.name.toLowerCase().includes(lowercasedTerm) || customer.nic.toLowerCase().includes(lowercasedTerm) || customer.measurementSets.some({
                        "DashboardPage.useMemo[filteredCustomers]": (set)=>set.jobNumber && set.jobNumber.toLowerCase().includes(lowercasedTerm) || set.orderStatus && set.orderStatus.toLowerCase().includes(lowercasedTerm)
                    }["DashboardPage.useMemo[filteredCustomers]"])
            }["DashboardPage.useMemo[filteredCustomers]"]);
        }
    }["DashboardPage.useMemo[filteredCustomers]"], [
...
_s(DashboardPage, "DcQaFd9bJ3/aZJKdTCni4ug0m98=", false, function() {
    return [
...
//# sourceMappingURL=_b0845d7d._.js.map