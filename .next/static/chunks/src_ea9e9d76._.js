...
_s(CustomerForm, "kN3hLHVhxkMpTOFEhswlibbQt1M=", false, function() {
    return [
...
"[project]/src/app/dashboard/customer/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        "CustomerDetailPage.useEffect": ()=>{
            if (isMounted) {
                const foundCustomer = customers.find({
                    "CustomerDetailPage.useEffect.foundCustomer": (c)=>c.id === params.id
                }["CustomerDetailPage.useEffect.foundCustomer"]);
                if (foundCustomer) {
...
_s(CustomerDetailPage, "dUKGiqRL0b+ExDj0BTVjTy2P1Go=", false, function() {
    return [
...
//# sourceMappingURL=src_ea9e9d76._.js.map