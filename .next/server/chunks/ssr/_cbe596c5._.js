...
function DashboardClientPage({ customers: initialCustomers }) {
    ...
    const handleLogout = async ()=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$89454e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logout"])();
    };
    const filteredCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return customers.filter((customer)=>customer.name.toLowerCase().includes(lowercasedTerm) || customer.nic.toLowerCase().includes(lowercasedTerm) || customer.measurementSets && customer.measurementSets.some((set)=>set.jobNumber && set.jobNumber.toLowerCase().includes(lowercasedTerm) || set.orderStatus && set.orderStatus.toLowerCase().includes(lowercasedTerm)));
    }, [
        searchTerm,
        customers
    ]);
...
//# sourceMappingURL=_cbe596c5._.js.map