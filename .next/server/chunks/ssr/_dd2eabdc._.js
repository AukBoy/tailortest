...
function DashboardPage() {
    ...
    const [, setAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLocalStorage"])('tailor-track-session', false);
    ...
    const filteredCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return customers.filter((customer)=>customer.name.toLowerCase().includes(lowercasedTerm) || customer.nic.toLowerCase().includes(lowercasedTerm) || customer.measurementSets.some((set)=>set.jobNumber && set.jobNumber.toLowerCase().includes(lowercasedTerm) || set.orderStatus && set.orderStatus.toLowerCase().includes(lowercasedTerm)));
    }, [
        searchTerm,
        customers
    ]);
...
//# sourceMappingURL=_dd2eabdc._.js.map